    ...
    <div class="container border rounded-lg w-3/4 mt-12 border-gray-300 p-6 mx-auto flex content-center font-sans shadow-2xl">
        ...
        <div class="text-center w-3/5 self-center">
            ...
            <div class="mt-2">
                ...
                <div v-if="authError" class="text-white mb-4 bg-red-400 p-4 w-1/2 mx-auto"><p>{{authError}}</p></div>
                <form @submit.prevent="login" @keydown="form.onKeydown($event)">
                    ...
                    <button  class="mt-8 mb-10 border-none rounded-full bg-mainColor px-16 py-2 text-white" type="submit">
                      <beat-loader :loading="isLoading" color="#fff" size="30px"></beat-loader>
                ...
                <div>
                    ...
                    <a href="/login/facebook" class="mt-8 mx-2 border-none rounded-full bg-blue-700 px-6 py-2 text-white" type="submit">With Facebook <i class="fa fa-facebook-square" aria-hidden="true"></i></a>
                </div>
